...
HistogramValue = _reflection.GeneratedProtocolMessageType('HistogramValue', (_message.Message,), dict(
...
StateSetValue = _reflection.GeneratedProtocolMessageType('StateSetValue', (_message.Message,), dict(
...
InfoValue = _reflection.GeneratedProtocolMessageType('InfoValue', (_message.Message,), dict(
